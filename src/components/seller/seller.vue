    ...
    <div class="seller-content">
      ...
      <div class="pics">
        ...
        <div class="pic-wrapper" ref="picWrapper">
          <ul class="pic-list" ref="picScroll">
    ...
    methods: {
      ...
      _initPic(){
        if (this.seller.pics) {
          ...
          this.$refs.picScroll.style.width = width + 'px';
          this.$nextTick(() => {
            if (!this.picScroll) {
      ...
      .supports
        .supports-item
          ...
          .icon
            ...
            &.decrease
              bg-img('img/decrease_4')
            &.discount
              bg-img('img/discount_4')
            &.guarantee
              bg-img('img/guarantee_4')
            &.invoice
              bg-img('img/invoice_4')
            &.special
              bg-img('img/special_4')
          .text
            font-size: 12px
            line-height: 16px
    .pics
